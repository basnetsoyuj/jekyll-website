...
var documents = [{
    ...
    "title": "Contact",
    "body": "ContactEmailing me at bsoyuj@gmail. com is still the best way to contact me. You can also follow and contact me via: 	 Twitter	 Instagram	 GitHub	 LinkedIn"
    }, {
    "id": 4,
    "url": "http://localhost:4000/",
    "title": "Home",
    "body": "      Featured:                                                                                                                                                                                                           baghchal v_1. 0. 1 Release                              :               baghchal is a pure Python Bagh Chal library that supports game import, move generation, move validation and board image rendering. It also comes with a. . . :                                                       27 Jul 2019                &lt;/span&gt;                                                                                                                                                                                                                                                                                  Zugzwang: An Imposed Elegance                              :               Introducing specific constraints on variables and functions, in mathematics, gives rise to numerous intricate patterns. This article discusses one such delicacy that arises in certain. . . :                                                       18 Jun 2019                &lt;/span&gt;                                                                                            All Stories:                                                                                                     baghchal v_1. 0. 1 Release              :       baghchal is a pure Python Bagh Chal library that supports game import, move generation, move validation and board image rendering. It also comes with a simple engine based on minimax. . . :                       27 Jul 2019        &lt;/span&gt;                                                                                                                     Zugzwang: An Imposed Elegance              :       Introducing specific constraints on variables and functions, in mathematics, gives rise to numerous intricate patterns. This article discusses one such delicacy that arises in certain board games like chess —. . . :                       18 Jun 2019        &lt;/span&gt;                                                                                                                     Manga Scraper              :        MangaScraper is python script makes manga reading faster, better and free of ads. :                       13 Feb 2018        &lt;/span&gt;                            			              Explore →:       				                              programming (2)                  python (2)                  chess (1)                  baghchal (1)                    			"
    }, {
    "id": 5,
    ...
    "id": 6,
    "url": "http://localhost:4000/baghchal-v_1.0.1-Release/",
    "title": "baghchal v_1.0.1 Release",
    "body": "2019/07/27 -  baghchal is a pure Python Bagh Chal library that supports game import, move generation, move validation and board image rendering. It also comes with a simple engine based on minimax algorithm and alpha-beta pruning. baghchal  Installation: baghchal runs on python 3 . You can now install it directly from PyPI via pip: 		pip install baghchal	System requirements are numpy and Pillow.  Source Code: The source code can be found here.  Download Release: In order to download and modify the code directly, you can download any one of the formats:baghchal-v_1. 0. 1. zipbaghchal-v_1. 0. 1. tar. gz You can use only the [baghchal_release_version]/baghchal directory and treat it as a module.  Documentation: The baghchal package has 3 sub-modules:  baghchal. env ( Consists of all classes and functions defining the game environment )     baghchal. env. Board (Board class representing BaghChal board)   baghchal. env. Bagh (Bagh class representing Bagh Player)   baghchal. env. Goat (Goat class representing Goat Player)      baghchal. lookup_table ( Lookup values for baghchal. env )   baghchal. engine ( Simple engine based on minimax algorithm and alpha-beta pruning )     baghchal. engine. Engine   More detailed documentation for baghchal library is available here.  License: baghchal is licensed under MIT License . Check out LICENSE. txt for the full text. "
    }, {
    "id": 7,
